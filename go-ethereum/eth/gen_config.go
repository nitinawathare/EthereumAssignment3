...
func (c Config) MarshalTOML() (interface{}, error) {
	...
	enc.InterArrival = c.InterArrival
	enc.HashPower = c.HashPower
	enc.Behavior = c.Behavior
...
func (c *Config) UnmarshalTOML(unmarshal func(interface{}) error) error {
	...
	if dec.InterArrival != nil {
		c.InterArrival = *dec.InterArrival
	}
	if dec.HashPower != nil {
		c.HashPower = *dec.HashPower
	}
	if dec.Behavior != nil {
		c.Behavior = *dec.Behavior
	}
