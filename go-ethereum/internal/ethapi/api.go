...
func DoCall(ctx context.Context, b Backend, args CallArgs, blockNr rpc.BlockNumber, vmCfg vm.Config, timeout time.Duration, globalGasCap *big.Int) ([]byte, uint64, bool, error) {
	...
	msg := types.NewMessage(addr, args.To, uint64(0), 0, value, gas, gasPrice, data, false)
...
func (args *SendTxArgs) toTransaction() *types.Transaction {
	...
	return types.NewTransaction(uint64(*args.TxType), uint64(*args.Nonce), *args.To, (*big.Int)(args.Value), uint64(*args.Gas), (*big.Int)(args.GasPrice), input)
}
